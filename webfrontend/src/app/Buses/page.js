...
export default function Buses() {
    ...
    const handleChange = (e) => {
      ...
      const handleSubmit = async (e) => {
        ...
        const response = await axios.post('http://localhost:4000/api/bus', formValues);
            ...
            <div className="overflow-x-auto">
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" className="px-6 py-3">Bus ID</th>
                            <th scope="col" className="px-4 py-3">Licence No</th>
                            ...
                            <th scope="col" className="px-4 py-3">Inspector ID</th>
                    ...
                    <tbody>
                        {data &&
                            data.map((c) => (
                                ...
                                <th scope="row" className="px-6 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{c.busId}</th>
                                <td className="px-4 py-3">{c.licenseNo}</td>
                                <td className="px-4 py-3">{c.model}</td>
                                <td className="px-4 py-3 ">{c.make}</td>
                                <td className="px-4 py-3">{c.driverId}</td>
                                <td className="px-4 py-3">{c.inspectorId}</td>
                                <td className="px-4 py-3 flex items-center justify-end">
                                    <EditDeleteBus id={c._id.toString()}/>
                                </td>
                            </tr>
                            ))}
                    </tbody>
